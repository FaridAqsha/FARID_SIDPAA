                    ...
                    <div class="card-body">
                        <form action="" method="POST" class="forms-sample" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_pengeluaran" value="<?= set_value('nama_pengeluaran'); ?>" class="form-control" id="nama_pengeluaran" placeholder="Nama Pengeluaran">
                                <?= form_error('nama_pengeluaran', '<small class="text-danger p1-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputtgldonasi">Tanggal Pengeluaran</label>
                                <input type="date" name="tgl_pengeluaran" value="<?= set_value('tgl_pengeluaran'); ?>" class="form-control" id="tgl_pengeluaran" placeholder="Tanggal Pengeluaran">
