            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Form Tambah Data Donasi Uang</h3>
                    </div>
                    <div class="card-body">
                        <form action="" method="POST" class="forms-sample" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="exampleInputUsername1">Nama Donasi</label>
                                <input type="text" name="nama_donasi" value="<?= set_value('nama_donasi'); ?>" class="form-control" id="nama_donasi" placeholder="Nama Donasi">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_donasi_uang" value="<?= set_value('tgl_donasi_uang'); ?>" class="form-control" id="tgl_donasi_uang" placeholder="Tanggal Donasi Uang">
